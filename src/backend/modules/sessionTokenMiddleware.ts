...
If It's valid, the next route handler is being called (for example "GET /users/datasets").
If it's not valid, it sends back a 401 Unauthorized response and does NOT call the next route handler.
